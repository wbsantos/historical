object frmCad_Interesse: TfrmCad_Interesse
  Left = 278
  Top = 330
  Width = 626
  Height = 290
  Caption = 'Cadastro de interesse'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object DBLookupComboBox2: TDBLookupComboBox
      ...
      Width = 109
      Height = 21
      DataField = 'codigo_cur'
      DataSource = DSinteresse
      KeyField = 'codigo_cur'
      ListField = 'nome_cur'
      ListFieldIndex = 1
      ListSource = DMeclipse.DStbcurso
      TabOrder = 2
    end
      ...
      object DBGrid2: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Data Inscri'#231#227'o'
            Width = 87
            Visible = True
          end>
      end
  ...
  object DSinteresse: TDataSource
    DataSet = ADOinteresse
    Left = 480
    Top = 48
  end
  object ADOinteresse: TADOQuery
    AutoCalcFields = False
    Connection = DMeclipse.ADOCBD
    CursorType = ctStatic
    BeforePost = ADOinteresseBeforePost
    Parameters = <
      item
        Name = 'CODIALU'
    ...
    SQL.Strings = (
      'SELECT tb_listaespera.*'
      'FROM tb_listaespera'
      'WHERE tb_listaespera.codigo_alu = :CODIALU')
    Left = 448
    Top = 48
    object ADOinteressecodigo_alu: TIntegerField
      FieldName = 'codigo_alu'
    end
    object ADOinteressecodigo_cur: TIntegerField
      FieldName = 'codigo_cur'
    end
    object ADOinteressedtficha_esp: TDateTimeField
      FieldName = 'dtficha_esp'
    end
    object ADOinteresseCurso: TStringField
      FieldKind = fkLookup
      FieldName = 'Curso'
      LookupDataSet = DMeclipse.TBcurso
      LookupKeyFields = 'codigo_cur'
      LookupResultField = 'nome_cur'
      KeyFields = 'codigo_cur'
      Size = 25
      Lookup = True
    end
    object ADOinteresseNome: TStringField
      FieldKind = fkLookup
      FieldName = 'Nome'
      LookupDataSet = DMeclipse.TBaluno
      LookupKeyFields = 'codigo_alu'
      LookupResultField = 'nome_alu'
      KeyFields = 'codigo_alu'
      Size = 35
      Lookup = True
    end
  end

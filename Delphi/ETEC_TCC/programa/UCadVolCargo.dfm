object frmCadVol_cargo: TfrmCadVol_cargo
  Left = 143
  Top = 238
  Width = 626
  Height = 290
  ...
  object ADOCargo: TADOQuery
    AutoCalcFields = False
    Connection = DMeclipse.ADOCBD
    CursorType = ctStatic
    BeforePost = ADOCargoBeforePost
    AfterPost = ADOCargoAfterPost
    Parameters = <
      item
        Name = 'CODIVOL'
    ...
    SQL.Strings = (
      'SELECT tb_cargo.*'
      'FROM tb_cargo'
      'WHERE tb_cargo.codigo_vol = :CODIVOL')
    Left = 448
    Top = 48
    object ADOCargocodigo_vol: TIntegerField
      FieldName = 'codigo_vol'
    end
    object ADOCargocargo_vol: TWideStringField
      FieldName = 'cargo_vol'
      Size = 25
    end
    object ADOCargoVoluntario: TStringField
      FieldKind = fkLookup
      FieldName = 'Voluntario'
      LookupDataSet = DMeclipse.TBvoluntario
      LookupKeyFields = 'codigo_vol'
      LookupResultField = 'nome_vol'
      KeyFields = 'codigo_vol'
      Size = 30
      Lookup = True
    end
  end

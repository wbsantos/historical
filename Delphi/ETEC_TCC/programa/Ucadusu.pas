...
begin
  If messagedlg('Tem certeza que deseja excluir esse usuário?'+#13+'Essa operação é irreversível!', mtconfirmation, [mbyes, mbno], 0) = mryes then
  begin
     if dbedit2.text='admin' then
...
begin
  If messagedlg('Tem certeza que deseja fechar o formulário de cadastro de usuários?', mtconfirmation, [mbyes, mbno], 0) = mryes then
  begin
    DMeclipse.TBusuario.cancel;
    canclose:=true;
  end
